...
impl VulkanoFormatExtension for Format {
    ...
    fn to_drm_fourcc(&self) -> Option<&'static [drm_fourcc::DrmFourcc]> {
        ...
        Some(match self {
            ...
            F::R8G8B8A8_UNORM => &[D::Abgr8888, D::Xbgr8888, D::Rgba8888, D::Rgbx8888],
            ...
            F::B8G8R8A8_UNORM => &[D::Argb8888, D::Xrgb8888, D::Bgra8888, D::Bgrx8888],
            F::B5G6R5_UNORM_PACK16 => &[D::Bgr565],
            F::B8G8R8_UNORM => &[D::Bgr888],
            // D::Bgr888_a8 => F::B8G8R8A8_UNORM,
